 ...
 * @LastEditors: Sky
 * @LastEditTime: 2020-03-24 15:10:47
...
TEST_CASE( "Test yBasicValue constructor and convert apis" , "[yBasicValue_ConstructorAndConvertApis]" ){
    ...
    SECTION("test yBasicValue() ") {
        ...
        REQUIRE(_tmp_value.GetyBasicValueType() == yLib::yBasicValueType::NONE_YBASICVALUE_TYPE);
    }
    ...
    SECTION("test yBasicValue(uint64_t value_)") {
        ...
        REQUIRE(_tmp_value.GetyBasicValueType() == yLib::yBasicValueType::UINT64_YBASICVALUE_TYPE);
    ...
    SECTION("test yBasicValue(double value_) ") {
        ...
        REQUIRE(_tmp_value.GetyBasicValueType() == yLib::yBasicValueType::DOUBLE_YBASICVALUE_TYPE);
