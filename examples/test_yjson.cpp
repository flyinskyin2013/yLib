 ...
 * @LastEditors: Sky
 * @LastEditTime: 2020-12-10 14:12:51
 * @Description: 
 */
#include "ylib.hpp"
...
void TEST_READ(void){
    ...
    if ( 0 > test_yjson.ReadFile("test.json") ){
    ...
    {//test deep copy
        ...
        yLib::yJsonValue _json_value = test_yjson.GetRootObject();
    }
    yLib::yJsonValue _json_value = test_yjson.GetRootObject();
    yLib::yLog::I("RootObject: _json_value is %s", _json_value.GetType() == yLib::yJsonValue::OBJECT_TYPE?"json object":"not json object");
    ...
    yLib::yLog::I("node null is %s", (_json_value["node_null"].GetType() == yLib::yJsonValue::NULL_TYPE)?"null":"not null");
    ...
    yLib::yLog::I("node array[4] is %s", (_json_value["node_array"][(uint64_t)4].GetType() == yLib::yJsonValue::OBJECT_TYPE)?"json object":"not json object" );
    yLib::yLog::I("node array[4] is str %s", ((std::string)_json_value["node_array"][(uint64_t)4]["node_array_obj"]).c_str() );
    yLib::yLog::I("node array[5] is %s", (_json_value["node_array"][(uint64_t)5].GetType() == yLib::yJsonValue::NULL_TYPE)?"null":"not null" );

    
    //json object
    yLib::yLog::I("node object is %s", (_json_value["node_object"].GetType() == yLib::yJsonValue::OBJECT_TYPE)?"json object":"not json object");
    ...
    yLib::yLog::I("sub node null is %s", (_json_value["node_object"]["sub_node_null"].GetType() == yLib::yJsonValue::NULL_TYPE)?"null":"not null");
    ...
    yLib::yLog::I("sub node array[4] is %s", (_json_value["node_object"]["sub_node_array"][(uint64_t)4].GetType() == yLib::yJsonValue::OBJECT_TYPE)?"json object":"not json object");
    yLib::yLog::I("sub node array[4] str is %s", ((std::string)_json_value["node_object"]["sub_node_array"][(uint64_t)4]["node_array_obj"]).c_str());
    yLib::yLog::I("sub node array[5] is %s", (_json_value["node_object"]["sub_node_array"][(uint64_t)5].GetType() == yLib::yJsonValue::NULL_TYPE)?"null":"not null" );
...
yLib::yJsonValue TEST_WRITE(void){
    ...
    yLib::yJsonValue root_value(yLib::yJsonValue::OBJECT_TYPE);
    yLib::yJsonValue object_value(yLib::yJsonValue::OBJECT_TYPE);
    yLib::yJsonValue array_value(yLib::yJsonValue::ARRAY_TYPE);
    ...
    json.SetRootObject(root_value);
    json.WriteFile("tmp.json");

    char* _buf_tmp = new char[2048];
    
    json.WriteMemory((int8_t *)_buf_tmp, 2048);
